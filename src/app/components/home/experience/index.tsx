                ...
                <div className="border-x border-primary/10">
                    <div className="flex flex-col max-w-3xl mx-auto py-10 px-4 sm:px-7">
                        <div className="flex flex-col xs:flex-row gap-5 items-center justify-between">
                            <p className="text-sm tracking-[2px] text-primary uppercase font-medium">Certifications</p>
                        </div>
                    </div>
                                    ...
                                    <div
                                        ...
                                        <div className="flex flex-wrap gap-5 items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-2.5 border border-primary/10 rounded-lg py-1.5 px-3">
                                                ...
                                                <p className="text-sm xs:text-base text-primary">{value?.status} · {value?.category}</p>
                                            </div>
                                        </div>
                                        <ul>
